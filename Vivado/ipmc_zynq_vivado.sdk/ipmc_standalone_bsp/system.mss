...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ad7689_s
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ad7689_s_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ad7689_s
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ad7689_s_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ad7689_s
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ad7689_s_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = led_controller
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_atca_led_ctrl
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = axi_gpio_hndl_sw
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.4
 PARAMETER HW_INSTANCE = axi_iic_pim400
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axi_jtag_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = spi
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = axi_quad_spi_dac
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = led_controller
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_user_led_ctrl
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = esm_axi_gpio_esm
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = spi
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = esm_axi_quad_spi_esm
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.2
 PARAMETER HW_INSTANCE = esm_axi_uartlite_esm
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ipmi_sensor_proc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ipmi_sensor_proc_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = elm_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.2
 PARAMETER HW_INSTANCE = elm_axi_uartlite_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = axi_gpio_xvctarget
END
