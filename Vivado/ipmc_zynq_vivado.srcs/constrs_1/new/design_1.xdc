...
set_property PACKAGE_PIN P15 [get_ports {GPIO[10]}]
set_property PACKAGE_PIN P16 [get_ports {GPIO[11]}]
set_property PACKAGE_PIN T19 [get_ports {GPIO[12]}]
set_property PACKAGE_PIN N15 [get_ports {GPIO[14]}]
set_property PACKAGE_PIN N16 [get_ports {GPIO[15]}]
...
set_property PACKAGE_PIN F20 [get_ports {PYLD12V_EN[0]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {PYLD12V_EN[0]}]
...
set_output_delay -clock [get_clocks clk_fpga_0] -min -add_delay 5.000 [get_ports pim400_i2c_scl_io]
set_output_delay -clock [get_clocks clk_fpga_0] -max -add_delay 5.000 [get_ports pim400_i2c_scl_io]
set_output_delay -clock [get_clocks clk_fpga_0] -min -add_delay 5.000 [get_ports pim400_i2c_sda_io]
set_output_delay -clock [get_clocks clk_fpga_0] -max -add_delay 5.000 [get_ports pim400_i2c_sda_io]
...
set_property OFFCHIP_TERM NONE [get_ports PYLD12V_EN[0]]
...
set_input_delay -clock [get_clocks clk_fpga_0] -min -add_delay 5.000 [get_ports pim400_i2c_scl_io]
set_input_delay -clock [get_clocks clk_fpga_0] -max -add_delay 5.000 [get_ports pim400_i2c_scl_io]
set_input_delay -clock [get_clocks clk_fpga_0] -min -add_delay 5.000 [get_ports pim400_i2c_sda_io]
set_input_delay -clock [get_clocks clk_fpga_0] -max -add_delay 5.000 [get_ports pim400_i2c_sda_io]
