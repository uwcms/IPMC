...
const std::string ANSICode::ANSI_ABSOLUTE_HORIZONTAL_POSITION_INTFMT = "\x1B[%dG";
const std::string ANSICode::ANSI_CURSOR_UP_ONE = "\x1B[A";
const std::string ANSICode::ANSI_CURSOR_UP_INTFMT = "\x1B[%dA";
const std::string ANSICode::VT102_INSERT_CHARACTER_POSITION = "\x1b[1@";
const std::string ANSICode::VT102_DELETE_CHARACTER_POSITION = "\x1b[1P";
const std::string ANSICode::VT102_INSERT_LINE = "\x1b[L";
const std::string ANSICode::VT102_INSERT_LINE_INTFMT = "\x1b[%dL";
